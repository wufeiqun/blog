...
确保pacemaker服务开机不启动,因为已经配置了以插件的方式启动了
[root@test3 ~]# chkconfig --list |grep pacemaker
pacemaker       0:关闭  1:关闭  2:关闭  3:关闭  4:关闭  5:关闭  6:关闭
...
location clusterIP-preffer MaxScale  inf: test3
