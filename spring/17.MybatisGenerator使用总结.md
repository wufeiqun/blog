...
<generatorConfiguration>
    ...
    <context id="user-context-id" targetRuntime="MyBatis3" defaultModelType="flat">
        ...
        <!-- 生成domain类的位置-->
        <javaModelGenerator targetPackage="com.mryx.demo.domain" targetProject="src/main/java">
        ...
        <!-- mapper接口生成的位置 -->
        <javaClientGenerator type="XMLMAPPER" targetPackage="com.mryx.demo.mapper" targetProject="src/main/java">
        </javaClientGenerator>
